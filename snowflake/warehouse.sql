...
LEFT JOIN BLUESKY_DP0.BLSWEB.WAREHOUSE_ANOMALY AS ANOMALY
ON WAREHOUSE.WAREHOUSE_NAME = ANOMALY.ROOT_CAUSE_ENTITY
WHERE TIME_DAY >= '2023-11-01'
AND TIME_DAY <= '2024-01-02'
GROUP BY WAREHOUSE.WAREHOUSE_NAME, WAREHOUSE_SIZE, FINDING_IDS, WAREHOUSE_TYPE, WAREHOUSE_SIZE, MIN_CLUSTER, MAX_CLUSTER, AUTO_SUSPEND, SCALING_POLICY, CATEGORIES
